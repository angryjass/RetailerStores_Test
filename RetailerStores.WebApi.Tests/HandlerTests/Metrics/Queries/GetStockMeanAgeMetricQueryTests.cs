...
{
    public class GetStockMeanAgeMetricQueryTests : InMemoryTestBase
    {
        private GetStockMeanAgeMetricQuery.Handler _handler;

        [SetUp]
        public void Setup()
        {
            _handler = new GetStockMeanAgeMetricQuery.Handler(DbContext);
        }

        [Test]
        public void HandlerIsWorking_Test()
        {
            var query = new GetStockMeanAgeMetricQuery();
