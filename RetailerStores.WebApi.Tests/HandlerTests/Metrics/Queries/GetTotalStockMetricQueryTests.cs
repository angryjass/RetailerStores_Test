...
{
    public class GetTotalStockMetricQueryTests : InMemoryTestBase
    {
        private GetTotalStockMetricQuery.Handler _handler;

        [SetUp]
        public void Setup()
        {
            _handler = new GetTotalStockMetricQuery.Handler(DbContext);
        }

        [Test]
        public void HandlerIsWorking_Test()
        {
            var query = new GetTotalStockMetricQuery();
