    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Backstock = table.Column<int>(type: "integer", nullable: false),
                    Frontstock = table.Column<int>(type: "integer", nullable: false),
                    ShoppingWindow = table.Column<int>(type: "integer", nullable: false),
                    Accuracy = table.Column<decimal>(type: "numeric", nullable: false),
                    OnFloorAvailability = table.Column<decimal>(type: "numeric", nullable: false),
                    MeanAge = table.Column<int>(type: "integer", nullable: false),
                    RecordingDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
